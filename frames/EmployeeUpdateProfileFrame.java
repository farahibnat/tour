...
{
	private JLabel userIdLabel,nameLabel, emailLabel, phoneNoLabel, genderLabel, ageLabel, addressLabel,designationLabel,salaryLabel;
	private JTextField userTF, nameTF, emailTF, phoneNoTF, genderTF, ageTF, addressTF, designationTF, salaryTF;
	...
	{
		super("Employee update self profile Frame");
		...
		this.employee=emp.searchEmployeeByUserId(u.getUserId());
		...
		this.designationLabel=new JLabel("Designation Type:");
		this.designationLabel.setBounds(50,400,100,30);
		this.panel.add(designationLabel);
		
		this.designationTF=new JTextField();
		this.designationTF.setBounds(160,400,100,30);
		this.designationTF.setText(employee.getDesignation());
		this.designationTF.setEditable(false);
		this.panel.add(designationLabel);
		
		this.salaryLabel=new JLabel("Salary:");
		this.salaryLabel.setBounds(50,400,100,30);
		this.panel.add(salaryLabel);
		
		this.salaryTF=new JTextField();
		this.salaryTF.setBounds(160,400,100,30);
		this.salaryTF.setText(String.valueOf(employee.getSalary()));
		this.salaryTF.setEditable(false);
		this.panel.add(salaryLabel);
