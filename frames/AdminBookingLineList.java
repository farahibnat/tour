...
public class AdminBookingLineList extends JFrame implements ActionListener
{
	...
	public AdminBookingLineList(User u)
	{
		super(" Admin View Booking Line");
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		if(command.equals(backBtn.getText()))
		{
			...
			AdminHomeFrame edf=new AdminHomeFrame(this.u);
